<h1>3849 - Equal Sum Grid Partition I</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/equal-sum-grid-partition-i/">equal-sum-grid-partition-i</a></h2><p>You are given an <code>m x n</code> matrix <code>grid</code> of positive integers. Your task is to determine if it is possible to make <strong>either one horizontal or one vertical cut</strong> on the grid such that:</p>
