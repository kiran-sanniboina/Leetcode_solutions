<h1>3902 - Maximize Spanning Tree Stability with Upgrades</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/maximize-spanning-tree-stability-with-upgrades/">maximize-spanning-tree-stability-with-upgrades</a></h2><p>You are given an integer <code>n</code>, representing <code>n</code> nodes numbered from 0 to <code>n - 1</code> and a list of <code>edges</code>, where <code>edges[i] = [u<sub>i</sub>, v<sub>i</sub>, s<sub>i</sub>, must<sub>i</sub>]</code>:</p>
