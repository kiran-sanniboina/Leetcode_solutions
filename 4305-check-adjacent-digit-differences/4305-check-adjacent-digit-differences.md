<h1>4305 - Check Adjacent Digit Differences</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/check-adjacent-digit-differences/">check-adjacent-digit-differences</a></h2><p>You are given a string <code>s</code> consisting of digits.</p>
